        ...
        for (int bx = 0; bx < NBx; ++bx) {
            ...
            if (y_in_bounds && x_in_bounds) {
                for (int r = 0; r < 8; ++r) {
                    ...
                    blk[r*8 + 0] = (short)gray[row_offset] - 128;
                    blk[r*8 + 1] = (short)gray[row_offset + 1] - 128;
                    blk[r*8 + 2] = (short)gray[row_offset + 2] - 128;
                    blk[r*8 + 3] = (short)gray[row_offset + 3] - 128;
                    blk[r*8 + 4] = (short)gray[row_offset + 4] - 128;
                    blk[r*8 + 5] = (short)gray[row_offset + 5] - 128;
                    blk[r*8 + 6] = (short)gray[row_offset + 6] - 128;
                ...
                for (int r = 0; r < 8; ++r) {
                    ...
                    int x = base_x;
                    blk[r*8 + 0] = (short)gray[row_offset + ((x < width) ? x : width_minus_1)] - 128; x++;
                    blk[r*8 + 1] = (short)gray[row_offset + ((x < width) ? x : width_minus_1)] - 128; x++;
                    blk[r*8 + 2] = (short)gray[row_offset + ((x < width) ? x : width_minus_1)] - 128; x++;
                    blk[r*8 + 3] = (short)gray[row_offset + ((x < width) ? x : width_minus_1)] - 128; x++;
                    blk[r*8 + 4] = (short)gray[row_offset + ((x < width) ? x : width_minus_1)] - 128; x++;
                    blk[r*8 + 5] = (short)gray[row_offset + ((x < width) ? x : width_minus_1)] - 128; x++;
                    blk[r*8 + 6] = (short)gray[row_offset + ((x < width) ? x : width_minus_1)] - 128; x++;
                    blk[r*8 + 7] = (short)gray[row_offset + ((x < width) ? x : width_minus_1)] - 128;
                }
            }
